<?php
add_action('after_setup_theme', 'love_not_game_theme_register_nav_menu');
add_filter('walker_nav_menu_start_el', 'love_not_game_theme_add_caret_to_menu', 10, 4);
add_filter('wp_nav_menu_args', 'my_wp_nav_menu_args');

function love_not_game_theme_register_nav_menu()
{
...
function love_not_game_theme_add_caret_to_menu($item_output, $item, $depth, $args) {
